      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
              ...
              <li <?php if(Lib\App::getRouter()->getController() == 'pedido'){?>class="active" <?php } ?>><a href="<?= Lib\App::getRouter()->getUrl('pedido') ?>">Pedido</a></li>
              <li <?php if(Lib\App::getRouter()->getController() == 'funcionario'){?>class="active" <?php } ?>><a href="<?= Lib\App::getRouter()->getUrl('funcionario') ?>">Login</a></li>
